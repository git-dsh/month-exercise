...
public class OSSFileUtil {
    ...
    String accessKeyId = "LTAI5tGqzhhmGpBRgLieQkRY";
    String accessKeySecret = "YsUEbgEnrQC5hg7rb8LF3RVVFLPpLO";
    String bucket = "dsh-server-oss";
    String ossUrl = "https://dsh-server-oss.oss-cn-beijing.aliyuncs.com/";
    /**
